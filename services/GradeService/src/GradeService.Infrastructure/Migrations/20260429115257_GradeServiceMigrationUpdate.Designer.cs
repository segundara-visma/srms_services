...
namespace GradeService.Infrastructure.Migrations
{
    ...
    [Migration("20260429115257_GradeServiceMigrationUpdate")]
    partial class GradeServiceMigrationUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GradeService.Domain.Entities.Grade", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GradeValue = 90.0m,
                            GradedAt = new DateTime(2025, 5, 20, 17, 59, 0, 0, DateTimeKind.Utc),
